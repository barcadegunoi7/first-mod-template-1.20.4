...
import net.barcadegunoi7.first_mod.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
	...
	private void setHeadAngles(float headYaw, float headPitch) {
		headYaw = MathHelper.clamp(headYaw, -30.00F, 30.00F);
		headPitch = MathHelper.clamp(headPitch, -25.00F, 45.00F);
